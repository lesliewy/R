...
typeAll <- "b";
pchAll <- 16;
pdfPath <- "/home/leslie/MyProject/OkParse/charts/corpLeagueCompare/";
pdf(file=paste(pdfPath, corpName, "_", resultFlag, "_", leagueNames[1], "_", leagueNames[2], "_", leagueNames[3], ".pdf", sep=""));
